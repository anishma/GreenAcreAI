...
async function testIntroduction() {
  console.log('🧪 Testing Introduction Handling')
  ...
  // Test: Introduction
  console.log('📤 Test: "My name is John Smith"')
...
customer_phone: +15559876543`,
  ...
  // Follow-up
  console.log('📤 Follow-up: "Yes, I need a lawn mowing quote"')
...
customer_phone: +15559876543`,
        ...
        {
          role: 'user',
          content: 'Yes, I need a lawn mowing quote',
        },
      ],
    }),
  })
